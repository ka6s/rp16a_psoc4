...
module SCB_P4_v4_0_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("8f8beccb-10a1-4706-8f63-7b83f12b774b/85e04463-fe73-4944-a43e-ce27d91f336d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8f8beccb-10a1-4706-8f63-7b83f12b774b/2a40dc14-87b1-41e7-85eb-165c55565779"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8f8beccb-10a1-4706-8f63-7b83f12b774b/38438ec5-732c-47a6-9805-e2b697fb82a2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8f8beccb-10a1-4706-8f63-7b83f12b774b/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8f8beccb-10a1-4706-8f63-7b83f12b774b/9613317f-9767-4872-a15a-e07325d93413"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__ant1_net;
	wire [0:0] tmpFB_0__ant1_net;
	wire [0:0] tmpIO_0__ant1_net;
	wire [0:0] tmpINTERRUPT_0__ant1_net;
	electrical [0:0] tmpSIOVREF__ant1_net;
	...
	cy_psoc3_pins_v1_10
		...
		ant1
		 (.oe(tmpOE__ant1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ant1_net[0:0]}),
		  .io({tmpIO_0__ant1_net[0:0]}),
		  .siovref(tmpSIOVREF__ant1_net),
		  .interrupt({tmpINTERRUPT_0__ant1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ant1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ant2_net;
	wire [0:0] tmpFB_0__ant2_net;
	wire [0:0] tmpIO_0__ant2_net;
	wire [0:0] tmpINTERRUPT_0__ant2_net;
	electrical [0:0] tmpSIOVREF__ant2_net;
	...
	cy_psoc3_pins_v1_10
		...
		ant2
		 (.oe(tmpOE__ant2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ant2_net[0:0]}),
		  .io({tmpIO_0__ant2_net[0:0]}),
		  .siovref(tmpSIOVREF__ant2_net),
		  .interrupt({tmpINTERRUPT_0__ant2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ant2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ant3_net;
	wire [0:0] tmpFB_0__ant3_net;
	wire [0:0] tmpIO_0__ant3_net;
	wire [0:0] tmpINTERRUPT_0__ant3_net;
	electrical [0:0] tmpSIOVREF__ant3_net;

	cy_psoc3_pins_v1_10
		#(.id("e1449ed1-d72c-4aa9-954c-e4515fd092e7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ant3
		 (.oe(tmpOE__ant3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ant3_net[0:0]}),
		  .io({tmpIO_0__ant3_net[0:0]}),
		  .siovref(tmpSIOVREF__ant3_net),
		  .interrupt({tmpINTERRUPT_0__ant3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ant3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
