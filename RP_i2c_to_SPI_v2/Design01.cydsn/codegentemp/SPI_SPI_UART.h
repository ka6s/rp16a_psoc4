...
#define SPI_SPI_RX_DATA_BITS_NUM       (16u)
#define SPI_SPI_TX_DATA_BITS_NUM       (16u)
#define SPI_SPI_WAKE_ENABLE            (0u)
#define SPI_SPI_BITS_ORDER             (1u)
#define SPI_SPI_TRANSFER_SEPARATION    (1u)
#define SPI_SPI_NUMBER_OF_SS_LINES     (3u)
...
#define SPI_SPI_INTR_TX_MASK           (0x200u)
...
/* Common APIs TX direction */
    ...
    void   SPI_SpiUartPutArray(const uint16 wrBuf[], uint32 count);
...
***************************************/
    ...
    /* RX direction */
        ...
        #define SPI_PutWordInRxBuffer(idx, rxDataByte) \
                do{                                                 \
                    SPI_rxBufferInternal[(idx)] = ((uint16) (rxDataByte)); \
                }while(0)
    ...
    /* TX direction */
        ...
        #define SPI_PutWordInTxBuffer(idx, txDataByte) \
                    do{                                             \
                        SPI_txBufferInternal[(idx)] = ((uint16) (txDataByte)); \
                    }while(0)
