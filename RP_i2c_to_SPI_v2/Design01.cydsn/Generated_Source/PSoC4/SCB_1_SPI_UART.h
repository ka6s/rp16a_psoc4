...
#define SCB_1_SPI_RX_DATA_BITS_NUM       (16u)
#define SCB_1_SPI_TX_DATA_BITS_NUM       (16u)
#define SCB_1_SPI_WAKE_ENABLE            (0u)
#define SCB_1_SPI_BITS_ORDER             (1u)
#define SCB_1_SPI_TRANSFER_SEPARATION    (1u)
#define SCB_1_SPI_NUMBER_OF_SS_LINES     (3u)
...
/* Common APIs TX direction */
    ...
    void   SCB_1_SpiUartPutArray(const uint16 wrBuf[], uint32 count);
...
***************************************/
    ...
    /* RX direction */
        ...
        #define SCB_1_PutWordInRxBuffer(idx, rxDataByte) \
                do{                                                 \
                    SCB_1_rxBufferInternal[(idx)] = ((uint16) (rxDataByte)); \
                }while(0)
    ...
    /* TX direction */
        ...
        #define SCB_1_PutWordInTxBuffer(idx, txDataByte) \
                    do{                                             \
                        SCB_1_txBufferInternal[(idx)] = ((uint16) (txDataByte)); \
                    }while(0)
